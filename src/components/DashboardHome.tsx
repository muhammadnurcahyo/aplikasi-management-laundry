...
export function DashboardHome({ 
  ...
  const handleExportCSV = () => {
    ...
    csvContent += "\uFEFF"; 
    csvContent += "Tanggal,Kategori,Deskripsi Pengeluaran,Metode Pembayaran,Jumlah (Rp),Catatan\n";
              ...
              .map(([catName, spec]) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isExpanded && (
                      <div 
                        className="mt-3.5 border-t border-zinc-800/80 pt-3.5 space-y-2 animate-fade-in text-left cursor-default"
                        onClick={(e) => e.stopPropagation()}
                      >
                        <div className="text-[8.5px] font-black tracking-widest text-[#10B981] uppercase mb-2 flex items-center justify-between">
